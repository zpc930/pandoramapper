...
enum ExitFlag { EF_EXIT, EF_DOOR, EF_ROAD, EF_CLIMB, EF_RANDOM, EF_SPECIAL, EF_NO_MATCH };
enum DoorFlag { DF_HIDDEN, DF_NEEDKEY, DF_NOBLOCK, DF_NOBREAK, DF_NOPICK, DF_DELAYED };
